...
![](https://github.com/KronicLabz/KronicLabz_NFT_Generator/blob/main/banner.png)
...
```sh
git clone https://github.com/KronicLabz/KronicLabz_NFT_Generator.git
```
...
To use a different metadata attribute name you can add the `displayName: "Awesome KronicKat"` to the `options` object. All options are optional and can be addes on the same layer if you want to.
    ...
    layersOrder: [
      ...
      { name: "KronicKatz" },
      {
        ...
        options: {
          ...
          opacity: 0.2,
          displayName: "Awesome KronicKat",
        },
      },
      { name: "Background" },
      { name: "Avatar" },
      { name: "Clothing", options: { blend: MODE.overlay, opacity: 0.7 } },
      { name: "Hair" },
    ],
  },
];
...
```json
{
  ...
  "image": "https://kroniclabz/nft/1.png",
  "edition": 1,
  "date": 1731990799975,
  "attributes": [
    { "trait_type": "Background", "value": "Black" },
    { "trait_type": "Eyeball", "value": "Red" },
    { "trait_type": "KronicKat", "value": "Yellow" },
